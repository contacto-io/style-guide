...
import * as AnIntroductionStories from './AnIntroduction.stories';

<Meta of={AnIntroductionStories} />
...
<Canvas>
  {/* <Story id="layout-card--card-with-table-inside" /> is deprecated, please migrate it to <Story of={referenceToStory} /> see: https://storybook.js.org/migration-guides/7.0 */}

  <Story id="layout-card--card-with-table-inside" />
</Canvas>
...
<Canvas>
  {/* <Story id="typography-text--all" /> is deprecated, please migrate it to <Story of={referenceToStory} /> see: https://storybook.js.org/migration-guides/7.0 */}

  <Story id="typography-text--all" />
</Canvas>
